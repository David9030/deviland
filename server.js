...
const CONFIG = {
    PORT: 3000,
    DEMONLORD: { MAX_HP: 5000, RESPAWN_TIME: 10000, SPEED: 15, ATTACK_COOLDOWN: 2000, ATTACK_DAMAGE: 145, VISION_RANGE: 200, EXP: 500 },
...
// MOVIMIENTO DE DEMONLORD - VERSIÓN SIMPLIFICADA
setInterval(() => {
    if (!demonlord.isAlive) return;
    ...
    // Movimiento - persigue SIEMPRE si hay objetivo
    if (distance > 70) {
